...
import CustomThemeModalComponent from '../components/nb-custom-theme-modal/custom-theme-modal.jsx';
import {setTheme} from '../reducers/theme.js';
import {persistTheme} from '../lib/themes/themePersistance.js';

class NBCustomThemeModal extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
...
const mapDispatchToProps = dispatch => ({
    ...
    onClose: () => dispatch(closeCustomThemeModal()),
