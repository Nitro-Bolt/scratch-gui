...
import allAroundIcon from './icon--all-around.svg?recolor';
import leftRightIcon from './icon--left-right.svg?recolor';
import dontRotateIcon from './icon--dont-rotate.svg?recolor';
