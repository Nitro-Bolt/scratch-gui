...
import {ACCENT_ORANGE, ACCENT_BLUE, ACCENT_MAP, ACCENT_PURPLE, ACCENT_RED, ACCENT_RAINBOW, ACCENT_TRANS, ACCENT_GAY, Theme} from '../../lib/themes/index.js';
...
const options = defineMessages({
    ...
    [ACCENT_GAY]: {
        defaultMessage: 'Gay',
        description: 'Name of color scheme that uses the gay colours :sunglasses:.',
        id: 'tw.accent.gay'
    }
});
