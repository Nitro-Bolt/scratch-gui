export default async function ({ addon, console, msg }) {
    ...
    const icons = {
        ...
        "exportIcon": `<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M15 17.5V12.5H17V17.5C17 18.8807 15.8807 20 14.5 20H2.5C1.11929 20 0 18.8807 0 17.5V2.5C0 1.11929 1.11929 0 2.5 0H5V2.5H2.5V17.5H15ZM14.1071 8.75H12.3214C11.0357 8.75 8.92857 8.75 5.89286 11.7857C5.89286 7.67857 8.92857 4.64286 11.9643 4.64286H14.1071V1.82143L19.6429 6.25L14.1071 10.6786V8.75Z" fill="#ffffff"/></svg>`
    }
