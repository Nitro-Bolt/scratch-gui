export default async function ({ addon, console, msg }) {
    ...
    const selectAllButton = createIconButton("Select All", selectAllIcon, selectAll);
    const unselectAllButton = createIconButton("Unselect All", unselectAllIcon, unselectAll);
    const deleteButton = createIconButton("Delete", deleteIcon, deleteSelected);
