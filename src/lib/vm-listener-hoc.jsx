...
const vmListenerHOC = function (WrappedComponent) {
    ...
    VMListener.propTypes = {
        ...
        onDebuggerBreakpoint: PropTypes.func.isRequired,
        onDebuggerClear: PropTypes.func.isRequired,
        onDebuggerLog: PropTypes.func.isRequired,
    ...
    const mapDispatchToProps = dispatch => ({
        ...
        onDebuggerLog: (type, message, target, color, targetBlock) => dispatch(pushLog(type, message, target, color, targetBlock)),
